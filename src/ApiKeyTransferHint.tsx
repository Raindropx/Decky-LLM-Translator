...
export const ApiKeyTransferHint: VFC = () => (
    <div style={{ color: '#9aa0a6', fontSize: '12px', lineHeight: 1.45, marginTop: '8px' }}>
        <div>
            ...
            Decky LocalSend (recommended for Gaming Mode) or KDE Connect and paste it here.
        </div>
        <div style={{ marginTop: '4px' }}>Only send API keys between devices you trust.</div>
        <Focusable style={{ display: 'flex', marginTop: '6px' }}>
            ...
            >
                <span style={{ display: 'inline-flex', alignItems: 'center', gap: '5px' }}>
                    <HiArrowTopRightOnSquare /> Decky Store: search “Decky LocalSend”
                </span>
            </DialogButton>
        </Focusable>
    </div>
